...
public class Graph extends JFrame {
        ...
        class DepoVertex {
            ...
            public List<Depo.DepoConnection> getDepoConnections() {
        ...
        public void paint(Graphics g) {
            for (DepoVertex dv : depoVertices) {
                for (Depo.DepoConnection depoConnection : dv.getDepoConnections()) {
                    drawPipe(g, depoConnection.getPipeDiameter(), dv.getX(), dv.getY(),
                            getDepoVertexById(depoConnection.getConnectedDepoID()).getX(),
                            getDepoVertexById(depoConnection.getConnectedDepoID()).getY());
                }
            }
            for (DepoVertex dv : depoVertices) {
                drawDepo(g, dv);
